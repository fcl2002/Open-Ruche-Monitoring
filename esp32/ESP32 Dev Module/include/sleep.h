...
// Disable voltage regulators (GPIO 12 & 13 LOW) — call before enter_deep_sleep()
void vreg_power_off();

// Emit 3 short beeps on the buzzer to signal system boot
void buzzer_boot_beep();

// Emit 1 long beep on the buzzer to signal entering deep sleep
